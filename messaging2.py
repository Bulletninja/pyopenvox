...
def fetch_messages():
    ...
    '''
    return messages_db.find({'status':{'$ne': 'sent'}, 'attempts' : {'$lt': max_attempts}, 'campaign': {'$exists': False}}).batchSize(batch_size)
